create table branch (id int, branch_name varchar(20), branch_code varchar(20), primary key(id));

create table account (id int, account_number varchar(20), branch_id int,
 full_name varchar(20),balance double, PRIMARY KEY (id),
